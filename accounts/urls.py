...
urlpatterns = [
    path('login/', auth_views.LoginView.as_view(template_name='registration/login.html', next_page='task_list'), name='login'),
    ...
    # Página de confirmação após envio do e-mail
    ...
    # Página de sucesso após redefinição
    path('reset/done/', 
